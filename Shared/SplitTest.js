...
function initializeTests()
{
    ...
    */
    ...
    var pinnedBlueprintTest = statsig.getExperiment("pinned_blueprints");
    var pinnedBlueprintTestValue = pinnedBlueprintTest.get("enabled", 0);
    console.log(pinnedBlueprintTestValue);
    pinnedBlueprintsManager.isEnabled = pinnedBlueprintTestValue == 1;
