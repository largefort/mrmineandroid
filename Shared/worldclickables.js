...
function onSpawnMineralDeposit()
{
    ...
    if(!isClickableAtDepth(depthToSpawn) && isSpawnableAtDepth(depthToSpawn))
    {
        ...
        var numMineralsToSpawn = bigNumberMin(new BigNumber(500000000), bigNumberMax(new BigNumber(parseInt(numMineralsToSpawnCandidate1)), new BigNumber(numMineralsToSpawnCandidate2)));
