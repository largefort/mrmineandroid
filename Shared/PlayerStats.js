...
var SCIENTIST_RESURRECTION_PERCENT_CHANCE = new stat(12, "Increases chance a scientist will immediately resurrect when killed by {0}%", STAT_OPERATION_INTEGER_ADD);
