...
titan.workerHireCosts = [
    ...
    new BigNumber(2700000000000000000000000),
    new BigNumber(7500000000000000000000000)
];
titan.workerLevelCosts = [
    new BigNumber(0),
    new BigNumber(20000000000000000000000000),
    new BigNumber(40000000000000000000000000),
    new BigNumber(80000000000000000000000000),
    new BigNumber(160000000000000000000000000),
    new BigNumber(320000000000000000000000000),
    new BigNumber(640000000000000000000000000),
    new BigNumber(1280000000000000000000000000),
    new BigNumber(2560000000000000000000000000),
    new BigNumber(5120000000000000000000000000),
    new BigNumber(10240000000000000000000000000)
];
worlds.push(titan);
